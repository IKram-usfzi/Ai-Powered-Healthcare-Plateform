# architecture.md §5 / TRD.md §8: a public subnet for the EC2 app tier and a
# private subnet (spanning 2 AZs — RDS's DB subnet group requirement) for RDS,
# which stays off the public internet.
