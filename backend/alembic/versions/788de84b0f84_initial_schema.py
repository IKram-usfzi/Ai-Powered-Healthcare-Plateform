...
Revision ID: 788de84b0f84
Revises: 
Create Date: 2026-08-22 11:32:08.859129
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('PATIENT', 'DOCTOR', 'ADMINISTRATOR', 'EXECUTIVE', name='user_role'), nullable=False),
    ...
    sa.Column('status', sa.Enum('SCHEDULED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', name='appointment_status'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    ...
    op.create_index(op.f('ix_health_readings_recorded_at'), 'health_readings', ['recorded_at'], unique=False)
    op.create_table('predictions',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('patient_id', sa.Integer(), nullable=False),
    sa.Column('risk_category', sa.Enum('LOW', 'MODERATE', 'HIGH', name='risk_category'), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['patient_id'], ['patients.id'], ),
    sa.ForeignKeyConstraint(['reading_id'], ['health_readings.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
